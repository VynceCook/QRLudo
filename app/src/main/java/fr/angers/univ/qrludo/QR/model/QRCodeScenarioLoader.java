...
public class QRCodeScenarioLoader extends QRCode{
    ...
    public QRCodeScenarioLoader(QrCodeJson code, String rawValue) {
        super(code, rawValue);


        Gson gson = new GsonBuilder().create();
        QRCodeJsonScenarioLoader codeScenario = gson.fromJson(rawValue, QRCodeJsonScenarioLoader.class);
