...
class MainApplication : Application() {
    ...
    companion object{
        ...
        var SR_beep_on : AtomicBoolean = AtomicBoolean(true) /// True if we want to play a beep before starting speech recognition
        ...
        fun load_preferences() {
            ...
            if (settings != null)
            {
                ...
                SR_beep_on.set(settings.getBoolean("sr_beep_on", true))
            }
        }
    }
}